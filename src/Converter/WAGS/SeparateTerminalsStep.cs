...
/// </summary>
public sealed class SeparateTerminalsStep : BaseConversionStep<WAG>
{
    /// <inheritdoc/>
    ...
    private void SeparateTerminalsInProduction(WAG grammar, Production production)
    {
    ...
    private void ReplaceTerminalInGrammar(WAG grammar, Terminal terminal)
    {
