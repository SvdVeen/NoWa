...
/// </summary>
public sealed class UnreachableSymbolsStep : BaseConversionStep<WAG>
{
    /// <inheritdoc/>
    ...
    private void EliminateNonGenerating(WAG grammar)
    {
    ...
    private ISet<Nonterminal> GetNongeneratingSymbols(WAG grammar)
    {
    ...
    private ISet<ISymbol> GetGeneratingSymbols(WAG grammar)
    {
    ...
    private static bool IsNonterminalGenerating(ISet<ISymbol> generatingSymbols, WAG grammar, Nonterminal nonterminal)
    {
    ...
    private void RemoveNongeneratingNonterminals(ISet<Nonterminal> nongeneratingSymbols, WAG grammar)
    {
    ...
    private void EliminateUnreachable(WAG grammar)
    {
        if (grammar.Productions.Count == 0)
        {
            return;
    ...
    private ISet<ISymbol> GetReachableSymbols(WAG grammar)
    {
